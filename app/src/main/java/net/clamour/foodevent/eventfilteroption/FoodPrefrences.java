...
public class FoodPrefrences extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_prefrences);
        ...
        toolbar1.setTitle("Food Prefrences");
        ...
        String[] values = new String[] { "American",
                "Asian",
                "Chinese",
                "Creole",
                "Eastern Europe",
