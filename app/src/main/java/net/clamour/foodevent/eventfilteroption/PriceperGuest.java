...
public class PriceperGuest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_priceper_guest);
        ...
        toolbar1.setTitle("Price per guest");
        ...
        String[] values = new String[] { "less than $20",
                "$20-35",
                "$35-50",
                "more than $50",
                "All",
