...
public class ViewMoreDescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_more_description);
        ...
        menu=intent.getStringExtra("description_st");
//        Log.i("menuuu",menu);
