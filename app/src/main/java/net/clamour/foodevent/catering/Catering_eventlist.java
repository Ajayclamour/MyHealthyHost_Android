...
public class Catering_eventlist extends AppCompatActivity implements ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catering_eventlist);
        ...
        eventListAdapter=new EventListAdapter (Catering_eventlist.this,event_list_array);
    ...
    public void onClick(View view, int position) {
        ...
        Intent intent=new Intent(Catering_eventlist.this, Catering_Evet_Details.class);
        ...
        intent.putExtra("cateogry_name","cat");
    ...
    public void eventListData(){
        ...
        pDialog = new ProgressDialog(Catering_eventlist.this);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(true);


        StringRequest stringRequest1 = new StringRequest(Request.Method.POST," http://myhealthyhost.com/api/catering_details.php",
