...
public class GuestSwitchsplash extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_switchsplash);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent i = new Intent(GuestSwitchsplash.this, GuestHomeScreen.class);
                startActivity(i);
    ...
    public void changeMode(){
        ...
        pDialog = new ProgressDialog(GuestSwitchsplash.this);
