...
public class TermsConditions extends AppCompatActivity {
    ...
    @BindView(R.id.user_agreement_guest)
    TextView userAgreementGuest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAgreementGuest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                Intent browserIntent = new Intent(Intent.ACTION_VIEW);
                browserIntent.setData(Uri.parse("http://myhealthyhost.com/Useragreementforguests.php"));
                startActivity(browserIntent);
