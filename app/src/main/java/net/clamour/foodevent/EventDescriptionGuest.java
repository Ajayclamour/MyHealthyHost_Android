...
public class EventDescriptionGuest extends AppCompatActivity {
  ...
  //  @BindView(R.id.event_timing_desc)TextView event_time_des;
    ...
    @BindView(R.id.viewmore_description)TextView viewmore_description;


    String event_background_image,host_image,host_name,event_name,event_address,event_price,no_of_guest,cusine_name,event_timing,event_description,experience,product_id;
    String user_outh_id,service_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_description_guest);
        ...
        if (cateogry_name.contains("social")) {
            ...
            Log.i("productidst", product_id_st);
            ...
            Glide.with(EventDescriptionGuest.this).load(coverimage_st)
                    .thumbnail(0.5f)
                    .crossFade()
                    .placeholder(0)
            ...
            Glide.with(EventDescriptionGuest.this).load(hostimage_st)
                    .thumbnail(0.5f)
                    .crossFade()
                    .placeholder(0)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
            ...
            viewmoremenu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent1=new Intent(EventDescriptionGuest.this, ViewMoreMenudetails.class);
        ...
        viewmore_description.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(EventDescriptionGuest.this, ViewMoreDescription.class);
    ...
    public void sendBookingDetails(){
        ...
        req_book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EventDescriptionGuest.this, GuestBooking.class);
        ...
        public void addWishList(){
            ...
            pDialog = new ProgressDialog(EventDescriptionGuest.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            if((isSucess==true)) {
                                ...
                                final android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(
                                        EventDescriptionGuest.this).create();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.i("responsedatasocialll",response_data);
...
//
//
        Glide.with(EventDescriptionGuest.this).load(event_background_image)
                .thumbnail(0.5f)
                .crossFade()
                .placeholder(0)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
