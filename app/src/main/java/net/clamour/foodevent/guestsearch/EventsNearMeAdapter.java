...
public class EventsNearMeAdapter extends ArrayAdapter<RecentActivityStorage> {
 ...
 //   @BindView(R.id.cusine_offered)TextView cusine_offered;
    ...
    public EventsNearMeAdapter(Activity context,ArrayList<RecentActivityStorage>recent_activity_array){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        host_name.setText(first_name+""+last_name);
        host_address.setText(address+""+city);
       // cusine_offered.setText(recent_activity_array.get(position).getUsername_host());
...
//        Log.i("service_host",host_services_st);
       ...
       // Log.i("pictureadapter",picture_st);
       ...
       // Log.i("outh_provider",outh_provider_st);
        ...
        String usernameHost=recent_activity_array.get(position).getUsername_host();
        Log.i("usernamehostmappppp",usernameHost);
...
//        }
        ...
        host_name.setText(host_name_st);
