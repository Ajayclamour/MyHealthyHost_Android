...
public class ViewMoreHostProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_more_host_profile);
        ...
        menu=intent.getStringExtra("abouthost");
//        Log.i("menuuu",menu);
